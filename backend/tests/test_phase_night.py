...
def test_multi_mafia_all_agree_kills_proposed_target():
    players = [
        Player(id="m1", name="Boss", role=Role.MAFIA, is_mafia_boss=True, known_mafia_ids=["m2"]),
...
def test_multi_mafia_underling_disagrees_boss_changes_mind():
    ...
    actors = {
        ...
        "m2": MockPlayer(
            {"night_underling_respond": {"agree": "no", "reasoning": "c2", "text": "c2가 더 의심"}}
        ),
        "c1": MockPlayer({}),
        "c2": MockPlayer({}),
    }
